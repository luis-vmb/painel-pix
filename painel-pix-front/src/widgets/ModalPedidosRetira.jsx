...
const ModalPedidosRetira = ({ pedidos = [], onDetalhes }) => {
  return (
    <div className="modal fade" id="modalPedidosRetira" tabIndex="-1" aria-labelledby="modalPedidosRetiraLabel" aria-hidden="true">
      <div className="modal-dialog modal-dialog-centered modal-xl">
        <div className="modal-content shadow">
          <div className="modal-header">
            <h5 className="modal-title" id="modalPedidosRetiraLabel">Pedidos — Retira</h5>
...
export default ModalPedidosRetira;
